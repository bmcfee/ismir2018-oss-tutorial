...
Windows users, we _highly_ recommend that you install the [Windows System for Linux][wsl-download], and Ubuntu.  You can then do the rest of this tutorial as a Linux user!
